...
import { Star, Plus, Timer, TrendingUp, Coins } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="stellar-surface border-0">
          ...
          <Card className="stellar-surface border-0">
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-body text-sm text-stellar-navy/70">Avg APY</p>
          ...
          <Card className="stellar-surface border-0">
            <CardContent className="p-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-body text-sm text-stellar-navy/70">Active Stakes</p>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <p className="font-body text-stellar-navy/70">
              {mockStakes.length} stakes available
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {mockStakes.map((stake) => (
              <Card key={stake.id} className="stellar-surface border-0 hover:shadow-stellar-gold transition-stellar cursor-pointer group">
